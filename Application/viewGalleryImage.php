                                    ...
                                    <div class="portlet-body">
                                        <div class="table-toolbar">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="btn-group">
                                                        <a href="addGallery.php"><button id="sample_editable_1_new" class="btn sbold green"><i class="fa fa-plus"></i>Add Gallery Image </button></a>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                        ...
                                        <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                                            ...
                                            ?>
                                                <tr class="odd gradeX">
                                                   ...
                                                   <td><?=$viewGalleryImage['galleryId']?></td>
                                                  <td> 
                                                        <?php
                                                        if($viewGalleryImage['galleryImage'] == ''){ ?>
                                                            <img src="http://source.unsplash.com/random" style="width: 120px;">
                                                       <?php } else { ?>
                                                        <img src="<?php echo 'gallery/'.$viewGalleryImage['galleryImage']; ?>" style="width: 120px;">
                                                            <?php
                                                        }
                                                        ?>
                                                    </td> 
                                                    ...
                                                    <td>
                                                    	<div class="btn-group" style="display: flex;">
                                                            ...
                                                            <button class="btn btn-xs red" type="submit" onclick="deletee(<?php echo $viewGalleryImage['galleryId'] ?>);" style="margin-left: 5px;"> Delete <i class="fa fa-edit"></i></button>
                                                        </div>                                          
                                                    </td> 
                                                </tr>  
											<?php } ?>              
