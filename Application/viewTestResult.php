                                    ...
                                    <div class="portlet-body">
                                        <div class="table-toolbar">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="btn-group">
                                                        <a href="addTestResult.php"><button id="sample_editable_1_new" class="btn sbold green"><i class="fa fa-plus"></i> Test Result</button></a>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                   ...
                                                   <td><?=$testResult['testResultHeading']?></td>
                                                    ...
                                                    <td>
                                                    	<div class="btn-group" style="display: flex;">
                                                            ...
                                                            <button class="btn btn-xs red" type="submit" onclick="deletee(<?php echo $testResult['resultId'] ?>);" style="margin-left: 5px;"> Delete <i class="fa fa-edit"></i></button>
                                                        </div>                                          
                                                    </td> 
                                                </tr>  
											<?php } ?>              
