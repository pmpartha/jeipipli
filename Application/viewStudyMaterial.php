                                    ...
                                    <div class="portlet-body">
                                        <div class="table-toolbar">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="btn-group">
                                                        <a href="addStudyMaterial.php"><button id="sample_editable_1_new" class="btn sbold green"><i class="fa fa-plus"></i> Study Material</button></a>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                            ...
                                            ?>
                                                <tr class="odd gradeX">
                                                   ...
                                                   <td><?=$studyMaterial['studyMaterialHeading']?></td>
                                                    ...
                                                    <td> <?=$studyMaterial['studyMaterial']?> </td>
                                                    ...
                                                    <td>
                                                    	<div class="btn-group" style="display: flex;">
                                                            ...
                                                            <button class="btn btn-xs red" type="submit" onclick="deletee(<?php echo $studyMaterial['studyId'] ?>);" style="margin-left: 5px;"> Delete <i class="fa fa-edit"></i></button>
                                                        </div>                                          
                                                    </td> 
                                                </tr>  
											<?php } ?>              
